...
export const Route = createFileRoute("/_authenticated/siswa/pembayaran")({
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Lakukan pembayaran melalui Virtual Account berikut.</p>
      </div>
        ...
        <div className="bg-gradient-primary p-6 text-primary-foreground">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">Bank Virtual SPMB</span>
            </div>
      ...
      {!lunas && (
        <Card className="p-6">
          <h3 className="font-semibold mb-2">Simulasi Pembayaran</h3>
          <p className="text-sm text-muted-foreground mb-4">
            Untuk keperluan demo, Anda dapat menandai pembayaran sebagai lunas dengan tombol di bawah.
            Pada implementasi nyata, status akan otomatis diperbarui oleh payment gateway.
          </p>
          <Button onClick={simulasiBayar} className="bg-gradient-primary">
            <CheckCircle2 className="mr-2 h-4 w-4" /> Tandai Sudah Bayar
          </Button>
        </Card>
      )}
    </div>
