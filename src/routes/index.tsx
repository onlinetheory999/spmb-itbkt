...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "SPMB PKBM Ibnu Taimiyah 2026-2027 | Pendaftaran Online SD, SMP, SMA" },
      { name: "description", content: "Pendaftaran online PKBM Ibnu Taimiyah jenjang SD, SMP, dan SMA tahun ajaran 2026-2027. Cepat, modern, dan terpercaya." },
    ],
  }),
  component: Index,
});
        ...
        {jenjang?.map((j, i) => (
          <Card key={j.id} className="group relative overflow-hidden p-6 border-border/60 hover:shadow-elegant transition-all hover:-translate-y-1">
            ...
            <div className="space-y-2 text-sm mb-5">
              ...
              <div className="flex justify-between"><span className="text-muted-foreground">Kuota</span><span className="font-semibold">{j.kuota} siswa</span></div>
